...
class SmileyGAN:
    ...
    def init(self):
        ...
        # self.visualize_input(training_data[0], ax)
        self.X_train = training_data / 127.5 - 1.
    ...
    def train(self, epochs, batch_size=128, save_interval=50):
        ...
        for epoch in range(epochs):
            ...
            if epoch % save_interval == 0:
                self.plot_generated_images(epoch, self.generator)

    def plot_generated_images(
            self, epoch, generator, examples=100, dim=(10, 10),
            figsize=(10, 10)):
        latent_dim = 100
